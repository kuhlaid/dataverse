...
cd ../
echo $(pwd)
cp $(pwd)/solr/8.11.1/schema.xml $(pwd)/testdata/
cp $(pwd)/solr/8.11.1/solrconfig.xml $(pwd)/testdata/
cp $(pwd)/jhove/jhove.conf $(pwd)/testdata/
cp $(pwd)/jhove/jhoveConfig.xsd $(pwd)/testdata/
cd ../
